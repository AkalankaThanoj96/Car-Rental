  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6">
        ...
        <p>
          <!-- p Starts -->
          <strong>Car Rental Group.</strong>
          <br>ABC Rd, New Castle 2002
          <br>
          <strong>Rental Group</strong>
...
<div id="copyright">
  ...
  <div class="container">
    ...
    <div class="col-md-6">
      ...
      <p class="pull-left"> &copy; 2024 Design By Thanoj </p>
